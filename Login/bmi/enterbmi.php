								...
								<form id="msform" action="survey_response.php" method="post">
									...
									<fieldset>
										<div class="form-card">
											...
											<div class="RadioGroup undefined">
												<div>
													<input type="radio" class="Radio" id="_qjjccyqsn" value="balanced" name="diet">
													<label for="_qjjccyqsn">Balanced Diet (Recommended)</label>
												</div>
												<div>
													<input type="radio" class="Radio" id="_lx6o8l7vi" value="low-carb" name="diet">
													<label for="_lx6o8l7vi">Low-Carb (Less than 20% of total calories from carbs)</label>
												</div>
												<div>
													<input type="radio" class="Radio" id="_wxlhkx5u3" value="low-fat" name="diet">
													<label for="_wxlhkx5u3">Low-Fat (Less than 15% of total calories from fat)</label>
												</div>
											</div>
										</div> 
										...
										<div class="form-card">
											...
											<div class="undefined">
												<div class="Checkbox">
													...
													<input type="checkbox" id="_7wputmnsq" name="health[]" value="vegan">Vegan (No meat, poultry, fish, dairy, eggs or honey)</label>
												</div>
												<div class="Checkbox">
													<label for="_5nhn0c3ek" class="Checkbox__label undefined">
													<input type="checkbox" id="_5nhn0c3ek" name="health[]" value="vegetarian">Vegetarian (No wheat, can have gluten though)</label>
												</div>
												<div class="Checkbox">
													<label for="_kmjzikt11" class="Checkbox__label undefined">
													<input type="checkbox" id="_kmjzikt11" name="health[]" value="alcohol-free">Alcohol-free (No alcohol used or contained)</label>
												</div>
												<div class="Checkbox">
													<label for="_ikxc1c1u0" class="Checkbox__label undefined">
													<input type="checkbox" id="_ikxc1c1u0" name="health[]" value="peanut-free">Peanut Free (No peanuts or products containing peanuts)</label>
												</div>
											</div>											
										</div> 
										<input type="button" name="previous" class="previous action-button-previous" value="Previous" /> 
									...
									<fieldset>
										<div class="form-card">
											...
											<div class="RadioGroup undefined">
												<div>
													<input type="radio" class="Radio caltake" id="_togn2lt9d" name="caltake" value="default">
													<label for="_togn2lt9d">Go with recommended</label>
												</div>
												<div>
													<input type="radio" class="Radio caltake" id="_kx2h38b30" name="caltake" value="custom">
													<label for="_kx2h38b30">Choose custom values</label>
												</div>
											</div>
											<div class="Survey__input" style="display:none">
												<input type="number" placeholder="min" name="calories[min]" value="1800">
												<input type="number" placeholder="max" name="calories[max]" value="2500">
											</div>
										</div>
										<input type="button" name="previous" class="previous action-button-previous" value="Previous" /> 
